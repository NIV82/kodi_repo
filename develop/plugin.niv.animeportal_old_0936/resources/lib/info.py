...
[/play]\n\
[news]\n\
[B][COLOR=darkorange]Version 0.9.33[/COLOR][/B]\n\
    - Исправлен ряд ошибок в Anidub\n\
    - Вернул отключение суб-плагинов (подготовка к общему поиску)\n\
[COLOR gray]=====================================================[/COLOR]\n\
[B][COLOR=darkorange]Version 0.9.28[/COLOR][/B]\n\
    - Добавлен пункт контекстного меню для [COLOR=blue]Animedia[/COLOR] - "[COLOR=gold]Обновить Зеркало[/COLOR]" - в самом первом меню ДО входа в суб-плагин\n\
    * Зеркала регулярно меняются и данный пункт позволит восстановить работоспособность плагина без прописывания руками\n\
[COLOR gray]=====================================================[/COLOR]\n\
[/news]\n\
[bugs]\n\
