...
class Anilibria:
    def __init__(self, addon_data_dir, params, addon, icon):
        ...
        self.fanart = icon.replace('icon.png', 'fanart.jpg')
...
#========================#========================#========================#
    ...
    #     if self.auth_mode:
    #         create_line(title='Избранное', params={'mode': 'common_part', 'param': 'favorites', 'portal': 'anilibria'})
    #     create_line(title='Поиск', params={'mode': 'search_part', 'portal': 'anilibria'})
    #     create_line(title='Расписание', params={'mode': 'schedule_part', 'portal': 'anilibria'})
    #     create_line(title='Новое', params={'mode': 'common_part', 'param': 'updated', 'portal': 'anilibria'})
    #     create_line(title='Популярное', params={'mode': 'common_part', 'param': 'popular', 'portal': 'anilibria'})
    #     create_line(title='Каталог', params={'mode': 'catalog_part', 'portal': 'anilibria'})
...
#========================#========================#========================#
    def exec_common_part(self):
        ...
        for data in data_array:
            ...
            #create_line(title=label, anime_id=anime_id, cover=cover, params={'mode': 'select_part', 'id': anime_id})
