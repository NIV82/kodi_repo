...
#========================#========================#========================#
        ...
        del DataBase
#========================#========================#========================#
    def _use_atl_names(self):
        return addon.getSetting('use_atl_names')
        ...
        if self.params['param']:
            ...
            for data in data_array:
                ...
                if 'data-code=' in data:
                    ...
                    if atl_names:
                        self.create_line(title='{}.{}'.format(serial_title,label), serial_id=self.params['id'], se_code=se_code, watched=is_watched, folder=False, params={
