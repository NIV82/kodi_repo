...
[/play]\n\
[news]\n\
[COLOR blue]version 0.4.2[/COLOR]\n\
- Правка функции обновления Актуального Адреса(раздел Информация)\n\
- Мелкие фиксы в коде\n\
\n\
- Версия под Py3-(Kodi 19) готова, но временно недоступна для установки через репозиторий. Только загрузка и установка через zip файл\n\
[COLOR gray]=========================================================================[/COLOR]\n\
...
[COLOR gray]=========================================================================[/COLOR]\n\
[COLOR blue]version 0.4.0[/COLOR]\n\
- Добавлена функция просмотра Онлайн с сайта\n\
[COLOR gray]=========================================================================[/COLOR]\n\
[COLOR blue]version 0.3.1[/COLOR]\n\
- Удален избыточный код\n\
- Мелкие фиксы\n\
- Исправлены ошибки в парсере Расписания\n\
- Обновлена и подчищена База Данных в репозитории\n\
- Смена Актуального Адреса на рабочий\n\
[COLOR gray]=========================================================================[/COLOR]\n\
[COLOR blue]version 0.3.0[/COLOR]\n\
- Добавлен раздел - Расписание (выхода серий)\n\
- Изменена структура основного меню\n\
- В раздел Информация добавлен пункт Обновить Базу Данных (контента много - много ошибок, кривых названий и подобного, до сих пор вычищаю), пункт позволяет удалить свою и скачать новую с репозитория.\n\
[COLOR gray]=========================================================================[/COLOR]\n\
