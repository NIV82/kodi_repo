    ...
    def exec_search_part(self):
        ...
        if self.params['param'] == '':
            ...
            for data in data_array:
                if data == '':
                    continue
                self.create_line(title='{}'.format(data), params={'mode': 'common_part', 'param':'search_part', 'search_string': quote_plus(data.encode('cp1251'))})
        ...
        if self.params['param'] == 'search':
            ...
            if skbd.isConfirmed():
                ...
                self.params['search_string'] = quote_plus(search_string.encode('cp1251'))
