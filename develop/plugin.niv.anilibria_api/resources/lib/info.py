...
- Рекомендуются: [COLOR blue]ELEMENTUM[/COLOR], [COLOR blue]TorrServer[/COLOR], [COLOR blue]Torrent2Http[/COLOR]. Остальные движки, на данный момент, еще не проверены\n\
- [COLOR=red]Внимание:[/COLOR] торрент движки и менеджеры устанавливаются отдельно\n\
- Вся необходимая информация по загрузке и установке этих плагинов находится на форуме [COLOR gold]xbmc.ru[/COLOR]\n\
[/play]\n\
[news]\n\
[COLOR blue]version 1.1.4[/COLOR]\n\
- Плагин переработан полностью и переведен Целиком на api.anilibria\n\
- В api, на данный момент, отсутствует Авторизация и соответственно Избранное с сайта\n\
- Для тестирования t2http под Kodi19 был добавлен соответствующий пункт в настройках\n\
    * torrent2http скачивается при первом запуске плагина (если он не установлен)\n\
- Раздел доступ к сайту содержит Тестовый набор зеркал - они нужны для скачивания торрент файла\n\
    * по умолчанию выбрано "приватное зеркало-1", рекомендуется его оставить\n\
- Предположительно для api разблокировка Не нужна, а торрент файлы загружаются с зеркал\n\
    * Пункт разблокировка Сохранен на случай блокировки функционала\n\
- Базы данных, увы, не совместимы - добавлены новые пукнты и структура.\n\
    * Старую БД пока Не удаляю, новая создается рядом с названием api_anilibria\n\
[COLOR gray]=========================================================================[/COLOR]\n\
...
[COLOR gray]=========================================================================[/COLOR]\n\
[COLOR orange]Elementum[/COLOR] | [COLOR blue]Win10[/COLOR] | [COLOR blue]Linux[/COLOR] | [COLOR gray]Android[/COLOR] | [COLOR gray]MacOS[/COLOR]\n\
[COLOR gray]=========================================================================[/COLOR]\n\
[COLOR orange]TorrServer[/COLOR] | [COLOR blue]Win10[/COLOR] | [COLOR blue]Linux[/COLOR] | [COLOR gray]Android[/COLOR] | [COLOR gray]MacOS[/COLOR]\n\
[COLOR gray]=========================================================================[/COLOR]\n\
[/comp]\n\
\n\
[bugs]\n\
...
genre = (
    "","боевые искусства","вампиры","демоны","детектив","драма","игры","исторический","комедия","магия","меха","мистика","музыка",
    "повседневность","приключения","психологическое","романтика","сверхъестественное","сёдзе","сейнен","сёнен","спорт","супер сила",
    "триллер","ужасы","фантастика","фэнтези","школа","экшен","этти")

year = (
    "", "2021", "2020", "2019", "2018", "2017", "2016", "2015", "2014", 
    "2013", "2012", "2011", "2010", "2009", "2008", "2007", "2006", "2005", 
    "2004", "2003", "2001", "1998", "1996"
)
...
status = {'Все': '','В работе': '1', 'Завершен': '2'}
sort = {'Новое': 'updated', 'Популярное': 'in_favorites'}
