...
#========================#========================#========================#
    def create_post(self):
        ...
        #     post['variables']['airedOn'] = {"startYear":int(addon.getSetting('sp_year_start')),"endYear":int(addon.getSetting('sp_year_end'))}
        ...
        #     if addon.getSetting('sp_voice_stat'):
        #         post['variables']['activity']['include'] = shizaproject_voice_stat[addon.getSetting('sp_voice_stat')]
...
#========================#========================#========================#
    def exec_main_part(self):
        self.create_line(title='[B]Релизы[/B]', params={'mode': 'common_part'})
        # self.create_line(title='[B]Поиск[/B]', params={'mode': 'search_part'})
        # self.create_line(title='[B]Онгоинги[/B]', params={'mode': 'common_part', 'param': 'ONGOING'})
        # self.create_line(title='[B]Завершенные[/B]', params={'mode': 'common_part', 'param': 'COMPLETED'})
...
#========================#========================#========================#
    ...
    #             addon.setSetting('sp_search', data_array)
...
#========================#========================#========================#
    ...
    #             addon.getSetting('sp_year_start')), params={'mode': 'catalog_part', 'param': 'sp_year_start'})
    #         self.create_line(title='Год (конец отрезка): [COLOR=gold]{}[/COLOR]'.format(
    #             addon.getSetting('sp_year_end')), params={'mode': 'catalog_part', 'param': 'sp_year_end'})  
    ...
    #             addon.getSetting('sp_voice_stat')), params={'mode': 'catalog_part', 'param': 'sp_voice_stat'})            
    ...
    #     if 'sp_year_start' in self.params['param']:
    #         result = self.dialog.select('Начало отрезка:', tuple(shizaproject_year))
    #         addon.setSetting(id='sp_year_start', value=tuple(shizaproject_year)[result])        
    #     if 'sp_year_end' in self.params['param']:
    #         result = self.dialog.select('Конец отрезка:', tuple(shizaproject_year))
    #         addon.setSetting(id='sp_year_end', value=tuple(shizaproject_year)[result])
    ...
    #     if 'sp_voice_stat' in self.params['param']:
    #         result = self.dialog.select('Сортировка по:', tuple(shizaproject_voice_stat.keys()))
    #         addon.setSetting(id='sp_voice_stat', value=tuple(shizaproject_voice_stat.keys())[result])
