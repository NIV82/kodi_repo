...
[/play]\n\
[news]\n\
[COLOR blue]version 1.1.9[/COLOR]\n\
- Мелкие правки, адаптация к новым блокировкам\n\
[COLOR gray]=========================================================================[/COLOR]\n\
[COLOR blue]version 1.1.7[/COLOR]\n\
- Плагин целиком переведен на api-v1\n\
    * ветка на основе api-v2 временно "заморожена"\n\
- Добавлена работа с зеркалами\n\
    * рекомендуется использовать приватное-1 или 2\n\
- База аниме данных оптимизирована и приведена под вид api-v1\n\
[COLOR gray]=========================================================================[/COLOR]\n\
[/news]\n\
[comp]\n\
