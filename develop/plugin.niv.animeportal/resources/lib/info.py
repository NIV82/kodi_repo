...
[B][COLOR=darkorange]Version 0.9.50[/COLOR][/B]\n\
    - Переписан anidub, добавлен отдельный парсер для anidub-torrent\n\
    - Базы данных для online и torrent разделены (anidub)\n\
    - Отдельные логины и пароли, сайты и авторизация\n\
    - Добавлен пробный пункт Использования Уже загруженных торрентов\n\
    - Исправления в логике парсеров и обратотке ошибок (anidub)\n\
